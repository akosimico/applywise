...
export function scheduleFollowUpSweep(store: ApplicationStore, pool?: pg.Pool) { void runFollowUpSweep(store, undefined, pool); return setInterval(() => void runFollowUpSweep(store, undefined, pool), 24 * 60 * 60 * 1000); }
