...
## Milestone 5 — Resume-Powered Job Discovery

- [x] Upload a PDF resume, extract text, and build an editable candidate profile (skills, target roles, location, and work preference)
- [x] Add an on-demand “Find possible jobs” action and manual refresh; do not run searches automatically
