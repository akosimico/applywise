...
4. Open `http://localhost:5173`. The API health route is at `http://localhost:3001/api/health`. Docker Postgres is exposed on `127.0.0.1:5433` to avoid conflicting with a local Postgres install.
